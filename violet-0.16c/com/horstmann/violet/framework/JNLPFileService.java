...
/**
 * This class provides a FileService for Java Web Start. Note that file saving
 * is strange under Web Start. You first save the data, and the dialog is only
 * displayed when the output stream is closed. Therefore, the file name is not
...
public class JNLPFileService extends FileService {
   ...
   public FileService.Open open(String defaultDirectory, String defaultFile, ExtensionFilter filter)
      ...
      if (defaultDirectory == null)
         defaultDirectory = ".";
      final FileContents contents = openService.openFileDialog(defaultDirectory, filter.getExtensions());
      return new FileService.Open() {
   ...
   public FileService.Save save(final String defaultDirectory, final String defaultFile, final ExtensionFilter filter,
      ...
      return new FileService.Save() {
         ...
         public void showDialog() throws IOException {
            contents = saveService.saveFileDialog(defaultDirectory, filter.getExtensions(),
