...
public abstract class FileService {
   ...
   /**
    * Gets an Open object that encapsulates the stream and name of the file that
    * the user selected
    * 
    * @param defaultDirectory
    *           the default directory for the file chooser
    * @param defaultFile
    *           the default file for the file chooser
    * @param extensions
    *           the extension filter
    * @return the Open object for the selected file
    * @throws IOException
    */
   public abstract Open open(String defaultDirectory, String defaultFile, ExtensionFilter extensions)
         throws IOException;

   /**
    * Gets a Save object that encapsulates the stream and name of the file that
    * the user selected (or will select)
    * 
    * @param defaultDirectory
    *           the default directory for the file chooser
    * @param defaultFile
    ...
    *           the extension to remove from the default file name
    * @param addExtension
   ...
   /**
    * An Open object encapsulates the stream and name of the file that the user
   ...
   /**
    * A Save object encapsulates the stream and name of the file that the user
    * selected for saving.
    */
   public interface Save {
       ...
       * Gets the name of the file that the user selected.
       * 
       * @return the file name, or null if the file dialog is only displayed
   ...
   private static class JFileChooserService extends FileService {
      ...
      public FileService.Save save(String defaultDirectory, String defaultFile, ExtensionFilter filter,
